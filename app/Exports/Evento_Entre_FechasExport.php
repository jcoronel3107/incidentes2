    ...
    */
    ...
    public function query()
    {
        if($this->tabla == '*'){
            ...
            //->join('parroquias', 'saluds.parroquia_id', '=', 'parroquias.id')
            ->select(
                    'fecha',
                    'nombre_incidente',
                    'direccion',
            ...
            //->join('parroquias', 'transitos.parroquia_id', '=', 'parroquias.id')
            ->select(
                    'fecha',
                    'nombre_incidente',
                    'direccion',
           ...
           return $downloadbusquedaentrefechas;
                ...
                //->join('parroquias', $this->tabla .'.parroquia_id', '=', 'parroquias.id')
                ->select(
                    'fecha',
                    'nombre_incidente',
                    'direccion',
