...
Route::get('/eventoE10/',							'MenuController@evento10')->middleware('auth');
Route::get('/eventoE11/',							'MenuController@evento11')->middleware('auth');
Route::get('/eventoE12/',							'MenuController@evento12')->middleware('auth');
Route::get('/eventoE13/',							'MenuController@evento13')->middleware('auth');
