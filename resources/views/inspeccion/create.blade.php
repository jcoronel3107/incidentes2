...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Nueva Inspección</h6>
    </div>
    <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="date" name="fecha_inspeccion" class="form-control @error('fecha_inspeccion') is-invalid @enderror" value="{{ old('fecha_inspeccion', date('Y-m-d')) }}" required>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="tipo_inspeccion" class="form-control @error('tipo_inspeccion') is-invalid @enderror" required>
                            ...
                            <option value="preventiva" {{ old('tipo_inspeccion') == 'preventiva' ? 'selected' : '' }}>Preventiva</option>
                            <option value="correctiva" {{ old('tipo_inspeccion') == 'correctiva' ? 'selected' : '' }}>Correctiva</option>
                            <option value="rutinaria" {{ old('tipo_inspeccion') == 'rutinaria' ? 'selected' : '' }}>Rutinaria</option>
                            <option value="especial" {{ old('tipo_inspeccion') == 'especial' ? 'selected' : '' }}>Especial</option>
                        </select>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="cargo_inspector" class="form-control @error('cargo_inspector') is-invalid @enderror" value="{{ old('cargo_inspector') }}">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="date" name="fecha_proxima_inspeccion" class="form-control @error('fecha_proxima_inspeccion') is-invalid @enderror" value="{{ old('fecha_proxima_inspeccion') }}">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="custom-control custom-checkbox mt-4">
                            <input type="checkbox" name="cumple_normativas" class="custom-control-input" id="cumple_normativas" {{ old('cumple_normativas') ? 'checked' : '' }}>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea name="recomendaciones" class="form-control @error('recomendaciones') is-invalid @enderror" rows="3">{{ old('recomendaciones') }}</textarea>
