            ...
            <div class="py-2 " id="table0.1">
                    <table class="table table-sm" id="datatable0.1">
                        <thead>
                            ...
                            <th class="table-dark">Orden</th>
                            <th class="table-dark">factura</th>
                            <th class="table-dark">placa</th>
                            <th class="table-dark">Conductor</th>
                                <th class="table-dark">fecha_carga</th>
                                
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($busquedaentrefechasclavexvehiculo as $registro)
                            <tr>
                                <td class="table-light">{{$registro->codigodis}}</td>
                                <td class="table-light">{{$registro->orden}}</td>
                                <td class="table-light">{{$registro->factura}}</td>
                                <td class="table-light">{{$registro->placa}}</td>
                                <td class="table-light">{{$registro->name}}</td>
                                <td class="table-light">{{$registro->created_at}}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
