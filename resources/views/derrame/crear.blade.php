	...
	<title>Hazmat - Crear - BCBVC</title>
	@endsection
		...
		<form method="post" action="/derrame">
			...
			<div class="form-row">
				<div class="form-group  input-group col-md-6">
					...
					<input type="time" class="form-control" name="hora_fin_emergencia" id="hora_fin_emergencia" value="" >
					<div class="input-group-append">
				...
				<div class="form-group  input-group col-md-6">
					...
					<input type="time" class="form-control" name="hora_en_base" id="hora_en_base"  value=""  >
					<div class="input-group-append">
