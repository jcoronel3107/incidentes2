	...
	<form id="formulario" method="post" action="/salud/{{$salud->id}}">
		...
		<div class="form-row"><!--Div Horas Evento-->
			<div class="form-group  input-group col-md-12">
				...
				<input type="datetime-local" class="form-control" name="hora_salida_a_emergencia" id="hora_salida_a_emergencia" value="{{old('hora_salida_a_emergencia',$salud->hora_salida_a_emergencia)}}" onblur="CheckTime(this);" placeholder="hh:mm:ss" required="">
			...
			<div class="form-group  input-group col-md-12">
				...
				<input type="datetime-local" class="form-control" name="hora_llegada_a_emergencia" id="hora_llegada_a_emergencia" value="{{old('hora_llegada_a_emergencia',$salud->hora_llegada_a_emergencia)}}" placeholder="hh:mm:ss" onblur="CheckTime(this);" required="">
				<div class="input-group-append">
		...
		<div class="form-row"><!--Div Horas Evento-->
			<div class="form-group  input-group col-md-12">
				...
				<input type="datetime-local" class="form-control" name="hora_fin_emergencia" value="{{old('hora_fin_emergencia',$salud->hora_fin_emergencia)}}" id="hora_fin_emergencia" onblur="CheckTime(this);" placeholder="hh:mm:ss">
				<div class="input-group-append">
			...
			<div class="form-group  input-group col-md-12">
				...
				<input type="datetime-local" class="form-control" name="hora_en_base" value="{{old('hora_en_base',$salud->hora_en_base)}}" id="hora_en_base" onblur="CheckTime(this);" placeholder="hh:mm:ss">
				<div class="input-group-append">
