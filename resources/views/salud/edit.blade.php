		...
		<form method="post" action="/salud/{{$salud->id}}">
			...
			<div class="form-row">
				<div class="form-group input-group col-md-4">
					...
					<textarea class="form-control" name="direccion" placeholder="Ubicacion del Evento" aria-label="With textarea">{{old('direccion',$salud->direccion)}}</textarea>
				</div>
				...
				<div class="form-group input-group col-md-4">
					...
					<textarea class="form-control" name="geoposicion" aria-label="With textarea">{{old('geoposicion',$salud->geoposicion)}}</textarea>
				</div>
			...
			<div class="form-row">
				<div class="form-group  input-group col-md-4">
					...
					<input type="text" class="form-control" name="hora_fin_emergencia" id="hora_fin_emergencia" placeholder="hh:mm:ss" value="{{old('hora_fin_emergencia',$salud->hora_fin_emergencia)}}"></div>
				<div class="form-group  input-group col-md-4">
					<div class="input-group-prepend">
			...
			<div class="form-group col-md-12">
				...
				<a class="btn btn btn-primary" role="button"
					href="{{ route('salud.index')}}">Cancelar
				</a>
			</div>
		</form>
		<form method="post" action="/salud/{{$salud->id}}">
