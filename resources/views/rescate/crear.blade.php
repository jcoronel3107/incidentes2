	...
	@section( "cuerpo" )
		...
		<h2 class="mt-5 shadow p-3 mb-5 bg-white rounded text-danger">Registro Información de Eventos 10-33</h2>
		<form method="post" action="/rescate">
			<div class="form-row">
				...
				<div class="form-group input-group  col-md-4">
					...
					<input type="date" name="fecha" class="form-control" placeholder="AA-MM-DD" value="{{old('fecha',$now->format('Y-m-m'))}}">
				</div>
			</div><!--Div Fecha-->
			<div class="form-row ">
				<div class='col-md-4'>
