	...
	@section( "cuerpo" )
		...
		@if(count($errors)>0)
			...
			@endforeach
		@endif
		<form id="formulario" method="post" action="/rescate/{{$rescate->id}}">
			@csrf @method('PATCH')
			...
			<div class="form-row"><!--Div Horas Evento-->
				<div class="form-group  input-group col-md-12">
					...
					<input type="datetime-local" class="form-control" name="hora_salida_a_emergencia" id="hora_salida_a_emergencia" value="{{old('hora_salida_a_emergencia',$rescate->hora_salida_a_emergencia)}}" onblur="CheckTime(this);" placeholder="hh:mm:ss" required="">
				...
				<div class="form-group  input-group col-md-12">
					...
					<input type="datetime-local" class="form-control" name="hora_llegada_a_emergencia" id="hora_llegada_a_emergencia" value="{{old('hora_llegada_a_emergencia',$rescate->hora_llegada_a_emergencia)}}" placeholder="hh:mm:ss" onblur="CheckTime(this);" required="">
					<div class="input-group-append">
			...
			<div class="form-row"><!--Div Horas Evento-->
				<div class="form-group  input-group col-md-12">
					...
					<input type="datetime-local" class="form-control" name="hora_fin_emergencia" value="{{old('hora_fin_emergencia',$rescate->hora_fin_emergencia)}}" id="hora_fin_emergencia" onblur="CheckTime(this);" placeholder="hh:mm:ss">
					<div class="input-group-append">
				...
				<div class="form-group  input-group col-md-12">
					...
					<input type="datetime-local" class="form-control" name="hora_en_base" value="{{old('hora_en_base',$rescate->hora_en_base)}}" id="hora_en_base" onblur="CheckTime(this);" placeholder="hh:mm:ss">
					<div class="input-group-append">
			...
			<div class="form-row"><!-- Daños Estimados  -->
				<div class="form-group input-group col-lg-12 col-md-12 col-sm-12">
					...
					<textarea onkeyup="mayus(this);" class="form-control" name="danos_estimados" id="danos_estimados">{{old('danos_estimados',$rescate->danos_estimados)}}</textarea>
				</div>
			</div>
			<hr>
			<div class="form-group"><!-- Botones  -->
				<button type="submit" name="Enviar" value="Enviar" class="btn btn-success">Actualizar</button>
				<a class="btn btn btn-primary" role="button" href="{{ route('rescate.index')}}">Cancelar</a>
			</div>
		</form>
		<form method="post" action="/rescate/{{$rescate->id}}"> <!-- Form Eliminar -->
			{{csrf_field()}}
