	...
	@section( "cuerpo" )
	<h2 class="mt-5 shadow p-3 mb-5 bg-white rounded text-danger">Adjunta Fichas SCI de Evento 10-42</h2>
	<div class="card">
				...
				<div class="col-md-12 col-md-offset-1">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<form method="POST" action="http://incidentes2.test/transitos/guardaform" accept-charset="UTF-8" enctype="multipart/form-data">
