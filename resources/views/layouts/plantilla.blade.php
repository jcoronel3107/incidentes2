...
<head>
	...
	<link href="{{ asset('css/varios.css') }}" rel="stylesheet">
	...
	<link href="{{ asset('vendor/fullcalendar/timeline/main.css') }}" rel="stylesheet">
...
<body onload="startTime()" id="page-top">
	...
	<script src="{{ asset('vendor/fullcalendar/timeline/main.js') }}"></script>
