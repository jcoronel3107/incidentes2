...
@section( "cabeza" )
		...
		<title>Solicitud_Clave - Index - BCBVC</title>
@endsection

@section( "cuerpo" )
		<h2 class="mt-2 shadow p-3 mb-2 bg-white rounded text-danger">Consulta Información de Solicitud_Clave_14</h2>
		...
		<table class="table p-3 table-hover table-condensed">
			...
			<tbody>
				...
				<tr>
					...
					@can('authorization')
					@if ($solicitud->status == 'Solicitado')
						<a class="btn btn-outline-info btn-sm" data-toggle="modal" title="Autorizar" data-target="#exampleModal_{{$solicitud->id}}" role="button"><i class="fas fa-check-double"></i></a>
					@endif
					@endcan
					</td>
				</tr>
