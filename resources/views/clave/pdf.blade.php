		...
		<div class="col-sm-12 col-md-12 col-lg-12">
			<table class="table table-condensed">
				<tr>
					...
					<td>
						<p class="bg-gray font-weight-bold">Vehículo</p>
					</td>
					<td>
				...
				<tr>
					<td>
						<span class="bg-gray font-weight-bold">Km Salida</span>
					</td>
					
					<td>
						<span class="bg-gray font-weight-bold">Km Gasolinera</span>
					</td>
					<td>
						<span class="bg-gray font-weight-bold">Km Llegada</span>
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					<td>
						<span class="bg-gray font-weight-bold">D¨®lares</span>
					</td>
					<td>
