      ...
      <div class="row">
        <div class="col-sm-3 mb-2">
          <div class="nav flex-md-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
            ...
            <a class="nav-link  p-2" data-toggle="pill" href="#createpermisos" role="tab" aria-controls="createpermisos" aria-selected="true">Crear Permisos</a>
            @endcan
            @can('edit permissions')
            <a class="nav-link  p-2" data-toggle="pill" href="#asignapermission" role="tab" aria-controls="asignapermission" aria-selected="false">Asignar Permisos</a>
            @endcan
            @can('edit rol')
            <a class="nav-link  p-2" data-toggle="pill" href="#rol" role="tab" aria-controls="rol" aria-selected="false">Asignar Rol</a>
            @endcan
        ...
        <div class="col-sm-9">
          <div class="tab-content" id="v-pills-tabContent">
            <div id="createpermisos" class="tab-pane fade" role="tabpanel" aria-labelledby="v-pills-profile-tab">
              <h2>Registrar Permisos</h2>
              <hr>
              <form action="{{ route('createpermiso') }}" method="POST">
                @csrf
                @method('PUT')
                

                <div class="form-group row">
                  <label class="col-sm-3 col-form-label text-sm-right">Nombre Permiso</label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control" value="" name="name" id="name">
                  </div><!-- /.col -->
                </div><!-- /.form-group row -->
                <div class="form-group row">
                  <label class="col-sm-3 col-form-label text-sm-right">Nombre Guard</label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control" value="web" name="guard_name" id="guard_name">
                  </div><!-- /.col -->
                </div><!-- /.form-group row -->
                <hr>
                <div class="form-group row">
            ...
            </div><!-- /#createpermisos-tab -->
            <div id="asignapermission" class="tab-pane fade" role="tabpanel" aria-labelledby="v-pills-profile-tab">
