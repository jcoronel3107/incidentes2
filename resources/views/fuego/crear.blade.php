	...
	<form id="formulario" method="post" action="{{ route('fuego.store')}}">
		...
		<!-- <div class="form-row" style="display: none;">
			<div class='col-md-12'>
				<div class="form-group">
					<div class="input-group date">
						<div class="input-group-prepend">
							<span class="input-group-text">Área Afectación</span>
						</div>
						<textarea spellcheck=true  class="form-control Text-uppercase" maxlength="2000" id="area_afectacion" name="area_afectacion" value="{{old('area_afectacion')}}" aria-label="With textarea" required></textarea>
					</div>
				</div>
			</div>
		</div> -->
		...
		<div class="form-row">
			<div class="form-group input-group col-lg-8 col-md-8 col-ms-12" id="area_afectacion_container">
				...
				<!--<textarea id="area_afectacion" class="form-control" maxlength="2000" name="area_afectacion" aria-label="With textarea">{{old('area_afectacion')}}</textarea>-->
				<input type="number" value=0 class="form-control" name="area_afectacion" id="area_afectacion" placeholder="Digite Valor en m2">
		...
		<div class="form-row"><!--Direcciones Ubicacion-->
			<div class="form-group input-group col-md-4">
				...
				<!-- onkeyup="mayus(this);" -->
				<textarea class="form-control" required name="direccion" id="pdireccion" placeholder="Ubicacion del Evento" aria-label="With textarea"></textarea>
	...
	<!-- Scripts para validacion de campos -->
	<script>
		document.addEventListener('DOMContentLoaded', () => {
		const selectIncidente = document.getElementById('incidente_id');
		const campoOculto = document.getElementById('area_afectacion_container').closest('.form-row');
