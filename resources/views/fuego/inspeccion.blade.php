...
@section( "cabeza" )
	<title>Fuego - Inspeccion - BCBVC</title>
@endsection

@section( "cuerpo" )
	<h2 class="mt-5 shadow p-3 mb-5 bg-white rounded text-danger">Registra Información de Inspección de Incendio</h2>
	...
	@endforeach
	@endif
	<form method="post" action="/registrainspeccionfuego">
		@csrf @method('PATCH')
		<div class="form-row">
			<div class="form-group input-group  col-md-4">
				...
				<input required readonly type="text" name="fecha" class="form-control" placeholder="AA-MM-DD" value="{{old('fecha',$incendio->fecha)}}">
			</div>
		</div><!--Div Fecha-->
			...
			<div class='col-md-4'>
				<div class="form-group">
					<div class="input-group">
						...
						<input required readonly type="text" name="hora_fichaecu911" class="form-control" placeholder="hh:mm:ss" value="{{old('hora_fichaecu911',$incendio->hora_fichaecu911)}}">
					</div>
				</div>
			</div>
			<div class='col-md-4'>
				<div class="form-group">
					<div class="input-group">
						...
						<input required readonly type="text" onkeyup="mayus(this);" name="ficha_ecu911" value="{{old('ficha_ecu911',$incendio->ficha_ecu911)}}" class="form-control">
					</div>
				</div>
			</div>
			...
			<div class='col-md-12'>
				<div class="form-group">
					<div class="input-group date" id="datetimepicker3">
						...
						<textarea required readonly id="pinformacion_inicial" class="form-control" maxlength="2000" name="informacion_inicial" aria-label="With textarea">{{old('informacion_inicial',$incendio->informacion_inicial)}}</textarea>
					</div>
				</div>
			</div>
		...
		<div class="form-row">
			<div class="form-group input-group col-md-4">
				...
				<textarea readonly required class="form-control" id="pdireccion" name="direccion" placeholder="Ubicacion del Evento" aria-label="With textarea">{{old('direccion',$incendio->direccion)}}</textarea>
			...
			<div class="form-group input-group col-md-4">
				...
				<textarea readonly required class="form-control" id="pgeoposicion" name="geoposicion" aria-label="With textarea">{{old('geoposicion',$incendio->geoposicion)}}</textarea>
			</div>
		...
		<div class="form-row">
			<div class="form-group  input-group col-md-6">
				...
				<input readonly required type="text" class="form-control" name="hora_salida_a_emergencia" id="hora_salida_a_emergencia" value="{{old('hora_salida_a_emergencia',$incendio->hora_salida_a_emergencia)}}" placeholder="hh:mm:ss">
			</div>
			<div class="form-group  input-group col-md-6">
				<div class="input-group-prepend">
		...
		<div class="form-row">
			...
			<div class="form-group  input-group col-md-6">
				...
				<input readonly required type="text" class="form-control" name="hora_en_base" id="hora_en_base" placeholder="hh:mm:ss" value="{{old('hora_en_base',$incendio->hora_en_base)}}">
			</div>
		</div>
		<!--Div Horas Evento-->
		...
		<div class="form-row">
			<div class="form-group input-group  col-md-12">
				...
				<input readonly required onkeyup="mayus(this);" type="text" class="form-control" name="usuario_afectado" id="usuario_afectado" value="{{old('usuario_afectado',$incendio->usuario_afectado)}}" placeholder="Digite Nombre Completo ciudadano afectado en la Emergencia">
			</div>
			...
			<div class="form-group input-group col-md-12">
				...
				<textarea readonly placeholder="Detalle los daños producidos por  el incidente" maxlength="2000" required class="form-control" name="danos_estimados" id="danos_estimados">{{old('danos_estimados',$incendio->danos_estimados)}}</textarea>
			</div>
