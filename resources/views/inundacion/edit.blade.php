	...
	<form method="post" action="/inundacion/{{$inundacion->id}}">
				...
				<div class="row">
						...
						<table id="persontable" class="table table-hover">
							...
							<thead>
									...
									@foreach($inundacion->users as $users)
		...
		<div class="form-row"><!--Div Horas Evento-->
			<div class="form-group  input-group col-md-12">
				...
				<input type="datetime-local" class="form-control" name="hora_salida_a_emergencia" id="hora_salida_a_emergencia" value="{{old('hora_salida_a_emergencia',$inundacion->hora_salida_a_emergencia)}}" onblur="CheckTime(this);" placeholder="hh:mm:ss" required="">
			...
			<div class="form-group  input-group col-md-12">
				...
				<input type="datetime-local" class="form-control" name="hora_llegada_a_emergencia" id="hora_llegada_a_emergencia" value="{{old('hora_llegada_a_emergencia',$inundacion->hora_llegada_a_emergencia)}}" placeholder="hh:mm:ss" onblur="CheckTime(this);" required="">
				<div class="input-group-append">
		...
		<div class="form-row"><!--Div Horas Evento-->
			<div class="form-group  input-group col-md-12">
				...
				<input type="datetime-local" class="form-control" name="hora_fin_emergencia" value="{{old('hora_fin_emergencia',$inundacion->hora_fin_emergencia)}}" id="hora_fin_emergencia" onblur="CheckTime(this);" placeholder="hh:mm:ss">
				<div class="input-group-append">
			...
			<div class="form-group  input-group col-md-12">
				...
				<input type="datetime-local" class="form-control" name="hora_en_base" value="{{old('hora_en_base',$inundacion->hora_en_base)}}" id="hora_en_base" onblur="CheckTime(this);" placeholder="hh:mm:ss">
				<div class="input-group-append">
					...
					<div class="row d-flex ">
							<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
								<table id="detalles" class="table table-hover">
									...
									<tbody>
										{{$cont = 0}}
										@foreach($inundacion->vehiculos as $items)
										{{$cont = $cont + 1}}
										<tr id="fila{{$cont}}">
		...
		<hr>
		<div class="form-group" id="divguardar"><!-- Botones  -->
		...
		<div class="form-group py-3 " >
			...
			<a class="btn btn btn-primary" role="button" href="{{ route('inundacion.index')}}">Cancelar</a>
				</li>
			</ul>
		</div><!-- Botones -->
	</form>
