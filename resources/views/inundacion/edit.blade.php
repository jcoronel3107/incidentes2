		...
		<form method="post" action="/inundacion/{{$inundacion->id}}">
			...
			<div class="form-row">
				<div class="form-group input-group col-md-4">
					...
					<textarea class="form-control" name="address" placeholder="Ubicacion del Evento" aria-label="With textarea">{{old('direccion',$inundacion->address)}}</textarea>
				</div>
				...
				<div class="form-group input-group col-md-4">
					...
					<textarea class="form-control" name="geoposicion" aria-label="With textarea">{{old('geoposicion',$inundacion->geoposicion)}}</textarea>
				</div>
			...
			<div class="form-row">
				<div class="form-group  input-group col-md-6">
					...
					<input type="text" class="form-control" name="hora_fin_emergencia" id="hora_fin_emergencia" placeholder="hh:mm:ss" value="{{old('hora_fin_emergencia',$inundacion->hora_fin_emergencia)}}"></div>
				<div class="form-group  input-group col-md-6">
					<div class="input-group-prepend">
