...
<!-- Required meta tags -->
    ...
    <title>Reporte Comision Servicio - BCBVC</title>
...
<div class="container">
		...
		<h2 class="mt-5 shadow p-3 mb-5 bg-white rounded">Consulta Registro Información de Comisión Servicio</h2>
			...
			<div class="col-lg-3 col-md-3 col-sm-12">
				...
				<p class=" text-info">{{$servicio->km_salida}}</p>
			</div>
			<div class="col-lg-3 col-md-3 col-sm-12">
				<span class="bg-gray font-weight-bold">km_retorno:</span>
				<p class=" text-info">{{$servicio->km_retorno}}</p>
			</div>
			<div class="col-lg-3 col-md-3 col-sm-12">
				<span class="bg-gray font-weight-bold">Delegante:</span>
				<p class=" text-info">{{$servicio->delegante}}</p>
			</div>
			<div class="col-lg-3 col-md-3 col-sm-12">
