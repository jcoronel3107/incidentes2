	...
	@section( "cuerpo" )
		<h2 class="mt-5 shadow p-3 mb-5 bg-white rounded text-danger">Editar Información de Estacion Bomberos</h2>
		<form method="post" action="/estacion/{{$estaciones->id}}">
			...
			<div class="form-row">
				...
				<div class="form-group input-group  col-md-8">
					...
					<input type="text" name="nombre" value="{{$estaciones->nombre}}" placeholder="Nombre / Estacion Bomberos" class="form-control"> {{csrf_field()}}
				</div>
			</div>
