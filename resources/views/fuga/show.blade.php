		...
		<div class="card-body">
			...
			<div class="row p-3">
				<div class="col-sm-12 col-md-12 col-lg-12">
					...
					<li><a rel="nofollow noopener noreferrer" target="_blank" href="{{asset('storage/fuga/'.$fuga->id.'/207.pdf')}}">Formulario 207 - PDF</a>
					</li>
					<li><a rel="nofollow noopener noreferrer" target="_blank" href="{{asset('storage/fuga/'.$fuga->id.'/211.pdf')}}">Formulario 211 - PDF</a></li>
