			...
			<div class="row p-3">
				<div class="col-sm-12 col-md-12 col-lg-12">
					...
					<ul>
						...
						<a class="btn btn-info btn-sm"  title="Descargar" rel="nofollow noopener noreferrer" target="_blank" href="{{asset('storage/fuga/'.$fuga->id.'/201.pdf')}}"><i class="fas fa-cloud-download-alt"></i></a>
					...
					<p class="text-info">Formulario 207 - PDF</p>
						<a class="btn btn-info btn-sm"  title="Descargar" rel="nofollow noopener noreferrer" target="_blank" href="{{asset('storage/fuga/'.$fuga->id.'/207.pdf')}}"><i class="fas fa-cloud-download-alt"></i></a>
					...
					<p class="text-info">Formulario 211 - PDF</p>
						<a class="btn btn-info btn-sm"  title="Descargar" rel="nofollow noopener noreferrer" target="_blank" href="{{asset('storage/fuga/'.$fuga->id.'/211.pdf')}}"><i class="fas fa-cloud-download-alt"></i></a>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
	  ...
	  <iframe src="{{asset('storage/fuga/'.$fuga->id.'/201.pdf')}}" width="50%" height="100%"></iframe>
      </div>
...
<div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel2" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
	  <iframe src="{{asset('storage/fuga/'.$fuga->id.'/207.pdf')}}" width="50%" height="100%"></iframe>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
      </div>
...
<div class="modal fade" id="exampleModal3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel3" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
	  <iframe src="{{asset('storage/fuga/'.$fuga->id.'/211.pdf')}}" width="50%" height="100%"></iframe>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
      </div>
