		...
		<div class="card-body">
			...
			<div class="row p-3">
				<div class="col-sm-12 col-md-12 col-lg-12">
					...
					<li>
						<a rel="nofollow noopener noreferrer" target="_blank" href="{{asset('storage/fuga/'.$fuga->id.'/201.pdf')}}">Formulario 201 - PDF</a>
					</li>
					<li><a rel="nofollow noopener noreferrer" target="_blank" href="{{asset('storage/fuga/'.$fuga->id.'/202.pdf')}}">Formulario 202 - PDF</a>
					</li>
					<li><a rel="nofollow noopener noreferrer" target="_blank" href="{{asset('storage/fuga/'.$fuga->id.'/206A.pdf')}}">Formulario 206A - PDF</a></li>
