		...
		<form method="post" action="/fuga/{{$fuga->id}}">
				...
				<div class='col-md-4'>
					<div class="form-group">
						<div class="input-group date" id="datetimepicker3">
							...
							<textarea class="form-control" name="informacion_inicial"  aria-label="With textarea" >{{old('informacion_inicial',$fuga->informacion_inicial)}}</textarea>
			...
			<div class="form-row">
				<div class="form-group input-group col-md-4">
					...
					<textarea class="form-control" name="direccion" placeholder="Ubicacion del Evento" aria-label="With textarea">{{old('direccion',$fuga->direccion)}}</textarea>
				</div>
				...
				<div class="form-group input-group col-md-4">
					...
					<textarea class="form-control" name="geoposicion" aria-label="With textarea">{{old('geoposicion',$fuga->geoposicion)}}</textarea>
				</div>
