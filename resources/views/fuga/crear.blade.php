						...
						<div class='col-md-6'>
							<div class="form-group">
								<div class="input-group">
									...
									<input type="datetime-local" id="hora_fichaecu911" name="hora_fichaecu911" class="form-control" onblur="CheckTime(this);" value="{{old('hora_fichaecu911',$now)}}" required="">
						...
						<div class='col-md-12'>
							<div class="form-group">
								<div class="input-group date">
									...
									<textarea class="form-control" name="informacion_inicial" maxlength="2000" id="pinformacion_inicial" aria-label="With textarea" required="">{{old('informacion_inicial')}}</textarea>
								</div>
							</div>
						</div>
				...
				<div class="card mt-4">
					<div class="form-row mt-4"><!--Div Ubicacion Evento-->
						...
						<div class="form-group input-group col-md-12 col-sm-12">
							...
							<input class="form-control" name="direccion" id="pdireccion" placeholder="Ubicacion del Evento" required="" value="{{old('direccion')}}">
						...
						<div class="form-group input-group col-md-12 col-sm-12">
							...
							<input class="form-control" id="pgeoposicion" name="geoposicion" placeholder="Formato:. -2.56985, -79.23658" value="{{old('geoposicion')}}">
						</div>
					</div>
