	...
	<form method="post" action="/fuga">
		...
		<div class="form-row">
			<div class="form-group input-group  col-md-12">
				...
				<textarea class="form-control" name="detalle_emergencia" maxlength="2000" id="detalle_emergencia" placeholder="Digite a detalle lo ocurrido en Emergencia" aria-label="With textarea" required="">{{old('detalle_emergencia')}}</textarea>
